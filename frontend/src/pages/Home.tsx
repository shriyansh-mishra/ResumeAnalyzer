...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6E9]">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[#A3B18A] via-[#A3B18A]/90 to-[#A3B18A]/80 animate-gradient-xy">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 relative">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-[#FAF6E9] text-[#03A6A1] px-10 py-4 rounded-full text-lg font-semibold hover:bg-[#F5F0E1] shadow-lg hover:shadow-xl transition-all duration-300"
              data-aos="fade-up"
              data-aos-delay="200"
            >
              Upload Your Resume
      ...
      {/* Upload Section */}
      <section id="upload-section" className="py-16 bg-[#FAF6E9]">
      ...
      {/* Features Section */}
      <section className="py-24 bg-[#FAF6E9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-[#FAF6E9] p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-[#A3B18A]/20"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                <div className="text-5xl mb-6 text-[#03A6A1]">{feature.icon}</div>
                ...
                <ul className="space-y-3">
                  {feature.benefits.map((benefit, idx) => (
                    <li key={idx} className="flex items-center text-gray-700">
                      <span className="text-[#03A6A1] mr-3">✓</span>
                      {benefit}
                    </li>
                  ))}
                </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {steps.map((step, index) => (
              <motion.div
                ...
                data-aos-delay={index * 100}
              >
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-12 h-12 bg-[#03A6A1] rounded-full flex items-center justify-center text-white text-xl font-bold">
                  {index + 1}
                </div>
                <div className="bg-[#FAF6E9] p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 pt-12">
                  <div className="text-5xl mb-6 text-[#03A6A1]">{step.icon}</div>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-[#03A6A1] to-[#03A6A1]/90 animate-gradient-x">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="col-span-1 md:col-span-2" data-aos="fade-up">
              ...
              <div className="flex space-x-6">
                <a href="https://www.linkedin.com/in/shriyansh-mishra-281919225/" className="text-gray-400 hover:text-[#03A6A1] transition-colors">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="#" className="text-gray-400 hover:text-[#03A6A1] transition-colors">
                  <span className="sr-only">Twitter</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                  </svg>
                </a>
                <a href="https://github.com/shriyansh-mishra" className="text-gray-400 hover:text-[#03A6A1] transition-colors">
            ...
            <div data-aos="fade-up" data-aos-delay="100">
              ...
              <ul className="space-y-4">
                <li><Link to="/features" className="text-gray-400 hover:text-[#03A6A1] transition-colors text-lg">Features</Link></li>
                <li><Link to="/about" className="text-gray-400 hover:text-[#03A6A1] transition-colors text-lg">About</Link></li>
                <li><Link to="/contact" className="text-gray-400 hover:text-[#03A6A1] transition-colors text-lg">Contact</Link></li>
                <li><Link to="/privacy" className="text-gray-400 hover:text-[#03A6A1] transition-colors text-lg">Privacy Policy</Link></li>
              </ul>
            </div>
