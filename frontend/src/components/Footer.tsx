      ...
      <div className="flex flex-col md:flex-row gap-6 text-center md:text-left">
        <div>
          ...
          <ul className="space-y-1">
            <li><Link to="/features" className="text-gray-600 hover:text-blue-600">Job Matching</Link></li>
            <li><Link to="/features" className="text-gray-600 hover:text-blue-600">Resume Analysis</Link></li>
            <li><Link to="/features" className="text-gray-600 hover:text-blue-600">Interview Prep</Link></li>
          </ul>
        </div>
        <div>
